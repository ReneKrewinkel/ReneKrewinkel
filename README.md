...
[room・id](https://room-id.org): Investigators are often left with only fragments of images—anonymous hotel rooms that all look the same. These spaces become silent backdrops of exploitation, nearly impossible to identify without the right tools. 
_Every room has a story. We help reveal where it was told._
